...
```{r}
full_data_life_plus_split <- data_split(full_data_life_plus,train_size= 0.75, seed = 123) # with this code the results of the first fold will be reproduced.
...
up_inside_t10 <- caret::train(Night_class_hypo_out ~ ., data = full_data_life_plus_train,
                   method = "ranger",
                   metric = "ROC",
...
### Save objects
To be able to reproduce the results later all the model results are stores in a list.
```{r}
rf_life_plus_models <- list(original=  original_t10,  smote_inside_t10=smote_inside_t10,up_inside_t10=  up_inside_t10,up_inside_own=  up_inside_own,smote_inside_own=  smote_inside_own, original_own= original_own,up_inside_ran=  up_inside_ran,smote_inside_ran=  smote_inside_ran,original_ran=  original_ran)

#saveRDS(rf_life_plus_models, file = "Data/Model_results/Trained_models/rf_models_life_plus_final.RData")
```
...
model <-  c("original","original_cost","smote_def","up_def",
           "up_own","smote_own","original_own","up_ran","smote_ran","original_ran")
metrics_rf_life_plus <- cbind(model,auc,sens,spec,accuracy)
metrics_rf_life_plus <- as.data.frame(metrics_rf_life_plus)
colnames(metrics_rf_life_plus) <- c("model","AUC","Sensitivity","Specificity","Accuracy")
metrics_rf_life_plus <- metrics_rf_life_plus %>%
...
### Save objects
```{r}
svm_life_plus_models <- list(original=svm_original_t10, smote_inside_t10=svm_smote_inside_t10,up_inside_t10=  svm_up_inside_t10,up_inside_own=   svm_up_inside_own,smote_inside_own=   svm_smote_inside_own, original_own=  svm_original_own,up_inside_ran=   svm_up_inside_ran,smote_inside_ran=   svm_smote_inside_ran,original_ran=   svm_original_ran)

#saveRDS(svm_life_plus_models, file = "Data/Model_results/Trained_models/svm_models_life_plus_final.RData")
```
...
### Save objects
```{r}
xgb_life_plus_models <- list(original=xgb_original_t10, smote_inside_t10=xgb_smote_inside_t10,up_inside_t10=  xgb_up_inside_t10,up_inside_own=   xgb_up_inside_own,smote_inside_own=   xgb_smote_inside_own, original_own=  xgb_original_own,up_inside_ran=   xgb_up_inside_ran,smote_inside_ran=   xgb_smote_inside_ran,original_ran=   xgb_original_ran)

#saveRDS(xgb_life_plus_models, file = "Data/Model_results/Trained_models/xgb_models_life_plus_final_1.RData")
```
...
### Save objects
```{r}
lasso_life_plus_models <- list(original=lasso_original_t10, smote_inside_t10=lasso_smote_inside_t10,up_inside_t10=  lasso_up_inside_t10,up_inside_own=   lasso_up_inside_own,smote_inside_own=   lasso_smote_inside_own, original_own=  lasso_original_own,up_inside_ran=   lasso_up_inside_ran,smote_inside_ran=   lasso_smote_inside_ran,original_ran=   lasso_original_ran)

#saveRDS(lasso_life_plus_models, file = "Data/Model_results/Trained_models/lasso_models_life_plus_final.RData")
```
...
#write.csv(all_models_lifestyle,"Data/Model_results/all_models_lifestyle_123.csv", row.names = FALSE)
#View(all_models_lifestyle)

#probs_life_plus_final <- list(rf= probabilities_data_rf, svm = probabilities_data_svm,xgb= probabilities_data_xgb, lasso =probabilities_data_lasso)
#saveRDS(probs_life_plus_final, file = "Data/Model_results/Trained_models/probs_lifestyle_123.RData")
```